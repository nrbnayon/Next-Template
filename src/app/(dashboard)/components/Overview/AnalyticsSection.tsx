...
export const AnalyticsSection = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-auto lg:h-[400px]">
      ...
      <Card className="w-full lg:w-1/2 bg-background dark:bg-primary-dark border-none rounded-3xl h-[350px] lg:h-full">
      ...
      <Card className="w-full lg:w-1/2 bg-background dark:bg-primary-dark rounded-3xl h-auto lg:h-full">
        <CardHeader className="pb-2 lg:pb-6">
